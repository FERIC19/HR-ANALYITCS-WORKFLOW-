...
| Analysis sheet (pivot tables / KPI source) | Visuals sheet (HR Workflow Overview dashboard) |
|---|---|
| ![Analysis sheet](images/analysis_sheet.png) | ![Visuals dashboard](images/visuals_dashboard.png) |
